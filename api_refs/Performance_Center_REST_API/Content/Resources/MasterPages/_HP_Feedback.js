...
<!-- <SF>	the following code does not inserts a line above and below the email body - replaces the above -->
	document.getElementById('hp-feedbackOpen').href = 'mailto:' + commentsEmailAddress + '?subject=Feedback on ' + productName + " " + productVersion + " documentation: " + firstheading + '&body=' + emailBody; <!-- Localizable -- >	
